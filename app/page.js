    ...
    <>
      ...
      <div className="container">
        ...
        <main id="main-content" role="main">
          {/* All your sections: about, ai-expertise, projects, skills, faq, contact */}
          <section
            id="about"
            className="section"
          ...
          >
            ...
            <div className="highlight-box">
              "The best problems are the ones everyone thinks are impossible
              until someone builds the solution."
            </div>
            <p>
              ...
              business operations and cutting-edge AI development, I build
              systems that actually work in production—processing over 1TB of
              data daily across enterprise clients.
            </p>
            ...
            <p>
              ...
              it's implementing RAG systems for enterprise knowledge management
              or building multi-agent workflows for complex automation, I focus
              on delivering measurable business value. My systems have processed
              over 10 million queries with 99.9% uptime across Fortune 500
              deployments.
            </p>

            <p>
              <strong>Recent Recognition:</strong> Led AI implementations that
              reduced manual processing time by 80% for a Fortune 500 financial
              services company, delivered custom LangChain agents that increased
              sales team productivity by 40%, and architected RAG systems now
              serving 50,000+ daily users with sub-200ms response times.
            </p>
          ...
          >
            ...
            <article className="vintage-border">
              ...
              <p>
                ...
                systems that scale to enterprise requirements. My
                implementations include advanced techniques like self-RAG,
                corrective RAG, and multi-stage retrieval for maximum accuracy
                and reliability. Current deployments handle 100,000+ documents
                with vector embeddings using ChromaDB, Pinecone, and Weaviate.
              </p>
              <p>
                <strong>Key Capabilities:</strong> Document processing pipelines
                (PDF, DOCX, HTML, JSON), vector database optimization with HNSW
                indexing, production monitoring with Prometheus/Grafana,
                multi-modal RAG with vision models, and enterprise security
                compliance (SOC2, GDPR, HIPAA). Average retrieval latency: 120ms
                at 95th percentile.
              </p>
            </article>
            ...
            <article className="vintage-border">
              ...
              <p>
                Expert in building intelligent agent workflows using LangChain
                and LangGraph frameworks. I create multi-agent systems that
                handle complex business processes with autonomous
                decision-making capabilities. Deployed agents handle 10,000+
                daily interactions with 95% task completion rates using custom
                tool integrations.
              </p>
              <p>
                ...
                auto-scaling on Kubernetes. Current agents process $2M+ in
                business transactions monthly.
              </p>
            </article>
            ...
            <article className="vintage-border">
              ...
              <p>
                ...
                commerce optimization with implementations managing $5M+ monthly
                ad spend and 500,000+ customer interactions.
              </p>
              <p>
          ...
          >
            ...
            >
              ...
              <div className="project-description" itemProp="description">
                ...
                Implemented multi-stage retrieval with 95% accuracy and
                sub-200ms response times. System processes documents in
                real-time and provides contextual answers with source
                attribution.
              </div>
            ...
            >
              ...
              <div className="project-description" itemProp="description">
                ...
                that converts text descriptions into professional videos.
                Handles dynamic scene composition, voiceover generation, and
                brand consistency. Reduced video production time from weeks to
                hours.
              </div>
              <div className="project-tech" itemProp="keywords">
            ...
            >
              Selected highlights from 20+ production applications across
              multiple industries:
            </p>
            ...
            >
              ...
              <div className="project-description" itemProp="description">
                B2B SaaS platform enabling dynamic PDF layouts and forms with
                CAD integration and 2D/3D visualizations using SVG. Serves
                enterprise real estate clients with complex workflow
                requirements.
              </div>
              <div className="project-tech" itemProp="keywords">
          ...
          <section id="faq" className="section" aria-labelledby="faq-heading">
            ...
            >
              ...
              >
                <p itemProp="text">
                  ...
                  business data to provide accurate, contextual responses. It
                  can improve customer service, automate documentation, and
                  enhance decision-making by 30-50%. I build RAG systems that
                  work with your existing data sources and scale to enterprise
                  requirements.
                </p>
              </div>
            </article>
            ...
            >
              ...
              >
                <p itemProp="text">
                  ...
                  monitoring, scaling strategies, and performance optimization.
                  My systems handle enterprise-level traffic with 99.9% uptime.
                  I use containerization, load balancing, and comprehensive
            ...
            >
              ...
              >
                <p itemProp="text">
                  ...
                  and compliance requirements. My cross-industry experience
                  helps identify unique opportunities for AI implementation.
                </p>
              </div>
            </article>
            ...
            >
              ...
              >
                <p itemProp="text">
                  Yes, I specialize in AI integration that works with your
                  current tech stack. Whether it's CRM systems, databases, APIs,
                  or legacy applications, I build bridges that let AI enhance
                  your existing workflows without disruption.
                </p>
              </div>
            </article>
            ...
            >
              ...
              >
                <p itemProp="text">
                  ...
                  encryption, secure data pipelines, privacy-compliant
                  processing, and enterprise-grade security practices. All
                  systems are designed to meet GDPR, CCPA, and industry-specific
            ...
            >
              <h3 className="faq-question" itemProp="name">
                What's the difference between LangChain and LangGraph for
            ...
            >
              ...
              >
                <p itemProp="text">
                  ...
                  audience targeting, creative testing, and conversion
                  prediction. I build systems that integrate with Meta's
                  Conversions API for privacy-compliant tracking and typically
                  achieve 20-35% improvement in ROAS.
                </p>
              </div>
            </article>
            ...
            >
              ...
              >
                <p itemProp="text">
                  I focus on business outcomes first, technology second. Every
                  AI solution I build is designed to solve specific problems and
                  deliver measurable results. I combine deep technical expertise
                  with business understanding to create systems that actually
            ...
            >
              ...
              >
                <p itemProp="text">
                  A production-ready RAG system typically takes 4-8 weeks to
                  implement, depending on data complexity and integration
                  requirements. This includes document processing setup, vector
                  database optimization, testing, and deployment with
                  monitoring.
                </p>
              </div>
            </article>
            ...
            >
              ...
              >
                <p itemProp="text">
                  Companies that need enterprise-grade AI solutions with proven
                  ROI. Best fit: Fortune 500 companies, fast-growing startups,
                  and businesses with complex data processing needs who want
                  reliable, scalable AI systems that integrate seamlessly with
                  existing workflows.
                </p>
              </div>
            </article>
            ...
            >
              ...
              >
                <p itemProp="text">
                  My AI implementations typically deliver 30-50% performance
                  improvements with ROI within 6-12 months. This includes
                  reduced manual work, faster decision-making, improved customer
                  satisfaction, and operational cost savings averaging
                  $100K-$500K annually per system.
                </p>
              </div>
            </article>
          </section>
          ...
          >
            ...
            <p>
              <strong>Best fit for:</strong> Enterprise AI implementations,
              custom RAG systems, agent workflows, social commerce optimization,
              and complex technical challenges that require both AI expertise
              and business acumen.
            </p>
